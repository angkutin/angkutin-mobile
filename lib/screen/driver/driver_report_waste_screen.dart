...
class DriverReportWasteScreen extends StatefulWidget {
  final User dataDriver;
  static const ROUTE_NAME = '/driver-reportscreen';

  const DriverReportWasteScreen({
    Key? key,
    required this.dataDriver,
  }) : super(key: key);

  @override
  State<DriverReportWasteScreen> createState() =>
      _DriverRequestWasteScreenState();
}

class _DriverRequestWasteScreenState extends State<DriverReportWasteScreen> {
  @override
  void initState() {
    super.initState();
    ...
    Future.microtask(() =>
        Provider.of<DriverServiceProvider>(context, listen: false)
          ..getReportFromUser(widget.dataDriver.email!));

    print("data driver ${widget.dataDriver.email}");
  }
          ...
          builder: (context, snapshot) {
            if (snapshot.hasError) {
              ...
              return Container(
                ...
                child: Text(
                  "Belum ada tugas laporan sampah",
